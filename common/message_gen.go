...
func (z *CancelForwardRequest) Msgsize() (s int) {
	...
	s += 6 + msgp.StringPrefixSize + len(z.Query) + 11 + 1 + 9 + msgp.StringPrefixSize + len(string(z.BrokerInfo.BrokerID)) + 17 + msgp.StringPrefixSize + len(z.BrokerInfo.ClientBrokerAddr) + 16 + msgp.StringPrefixSize + len(z.BrokerInfo.CoordBrokerAddr)
	return
}
