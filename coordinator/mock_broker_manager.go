...
func (_m *MockBrokerManager) ConnectBroker(brokerInfo *common.BrokerInfo, commConn CommConn) error {
	ret := _m.Called(brokerInfo, commConn)

	var r0 error
	if rf, ok := ret.Get(0).(func(*common.BrokerInfo, CommConn) error); ok {
		r0 = rf(brokerInfo, commConn)
	} else {
		r0 = ret.Error(0)
	}
